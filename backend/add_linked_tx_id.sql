...
BEGIN
    ...
    FOR rec IN (
        ...
        BEGIN
            ...
            tx_linked_id := (rec.raw_data->>'linked_tx_id')::UUID;
            ...
            ELSE
                INSERT INTO public.finance_transactions (
                    user_id, date, amount, type, category, method, description, source, external_ref_id, linked_tx_id
                ) VALUES (
                    tx_user_id, tx_date, tx_amount, tx_type, tx_category, tx_method, tx_desc, tx_source, comp_hash, tx_linked_id
                );
